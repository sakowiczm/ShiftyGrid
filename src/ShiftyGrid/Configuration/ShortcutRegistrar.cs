...
public class ShortcutRegistrar
{
    ...
    /// <summary>
    /// Registers all shortcuts and modes from configuration
    /// </summary>
    ...
    /// <summary>
    /// Registers a single shortcut with all its bindings
    /// </summary>
    ...
    /// <summary>
    /// Registers a modal mode with all its shortcuts
    /// </summary>
    ...
    /// <summary>
    /// Event handler for shortcut triggers - spawns CLI process to handle command
    /// </summary>
